...
def fail_safe(
    ...
    """
    prod_per_sec = temperature * neutrons_produced_per_second
    threshold_range = 0.1 * threshold

    if prod_per_sec < threshold - threshold_range:
        return "LOW"
    if abs(prod_per_sec - threshold) <= threshold_range:
        return "NORMAL"
    return "DANGER"
